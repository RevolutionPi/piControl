...
#define   DEFAULT_TX_CTRL             ( TX_CTRL_ICMP_CHECKSUM | TX_CTRL_UDP_CHECKSUM | \
                                        ...
                                        TX_CTRL_FLOW_ENABLE | \
                                        TX_CTRL_PAD_ENABLE | TX_CTRL_CRC_ENABLE )
...
#define   DEFAULT_RX_CTRL1           (RX_CTRL_BROADCAST |     \
                                      RX_CTRL_ALL_MULTICAST| RX_CTRL_UNICAST | RX_CTRL_BAD_PACKET | RX_CTRL_PROMISCUOUS)
...
#define   INT_MASK                    ( INT_RX  ) //| INT_TX | INT_PHY | INT_TX_SPACE
...
#define   CHIP_ID_8851_16             0x8872     /* KS8851-16/32MQL chip ID */

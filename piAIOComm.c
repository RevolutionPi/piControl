...
INT32U piAIOComm_Init(INT8U i8uDevice_p)
{
    ...
    pr_info_aio("piAIOComm_Init %d of %d  addr %d numCnt %d\n", i8uDevice_p, i8uConfigured_s,
...
//                      i8uAddress, sResponse_l.uHeader.sHeaderTyp1.bitCommand, sResponse_l.uHeader.sHeaderTyp1.bitLength);
	    ...
	    {
		i32uRv_l = 1;
		pr_info_aio("dev %2d: recv ioprotocol crc error\n",
			  i8uAddress
			  );
	    }
	}
